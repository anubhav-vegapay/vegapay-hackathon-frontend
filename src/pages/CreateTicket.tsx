          ...
          <form className='rounded-md bg-white border border-[#E1E4EB]' onSubmit={handleSubmit}>
            ...
            <div className='flex flex-col space-y-3 p-3'>
              ...
              <div className='flex flex-col'>
                ...
                <textarea required name="user_message" id="user_message" placeholder='Enter your query' onChange={(e) => setForm((prev) => ({ ...prev, [e.target.name]: e.target.value }))} className='border border-[#E1E4EB] rounded-md min-h-48 p-2'></textarea>
              </div>
            </div>
          </form>
